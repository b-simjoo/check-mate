...
Original file is located at
    https://colab.research.google.com/drive/1SRSELjEnbjdPbq_4X7E6FG3kV1bJspVl
"""
    ...
    for index in range(y - 1, -1, -1):
        if checkboard[x][index] % 3 == 0 and checkboard[x][index] != 0:
            break
              ...
              if checkboard[x][index] == EBISHOP or checkboard[x][index] == EQUEEN:
                is_check = True
              break
    if 7 >= y > 0:
        yindex = y - 1
        for index in range(x - 1, -1, -1):
            if checkboard[index][yindex] % 3 == 0 and checkboard[index][yindex] != 0:
              ...
              if checkboard[index][yindex] == EBISHOP or checkboard[index][y] == EQUEEN:
                is_check = True
              break
            elif 7 >= yindex > 0:
                yindex = yindex - 1
